...
namespace Project.DAL.FactoryClasses
{
	...
	{
		private static readonly Dictionary<Project.DAL.EntityType, string> _entityTypeNamesCache = new Dictionary<Project.DAL.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(Project.DAL.EntityType value in Enum.GetValues(typeof(Project.DAL.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(Project.DAL.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(Project.DAL.EntityType relatedEntityType)
		{
