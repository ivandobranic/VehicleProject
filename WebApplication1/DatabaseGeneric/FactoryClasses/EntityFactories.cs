...
namespace Project.DAL.FactoryClasses
{
	...
	{
		private readonly Project.DAL.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, Project.DAL.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		{
			return GeneralEntityFactory.Create((Project.DAL.EntityType)entityTypeValue);
		}
	...
	public partial class VehicleMakeEntityFactory : EntityFactoryBase2<VehicleMakeEntity> {
		/// <summary>CTor</summary>
		public VehicleMakeEntityFactory() : base("VehicleMakeEntity", Project.DAL.EntityType.VehicleMakeEntity, false) { }
		
		/// <summary>Creates a new VehicleMakeEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new VehicleMakeEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewVehicleMakeUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
	...
	public partial class VehicleModelEntityFactory : EntityFactoryBase2<VehicleModelEntity> {
		/// <summary>CTor</summary>
		public VehicleModelEntityFactory() : base("VehicleModelEntity", Project.DAL.EntityType.VehicleModelEntity, false) { }
		
		/// <summary>Creates a new VehicleModelEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new VehicleModelEntity(fields);
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(Project.DAL.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((Project.DAL.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Project.DAL.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Project.DAL.EntityType typeOfEntity)
		{
	...
	{
		/// <summary>Gets the factory of the Entity type with the Project.DAL.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Project.DAL.EntityType)Enum.Parse(typeof(Project.DAL.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation((Project.DAL.EntityType)Enum.Parse(typeof(Project.DAL.EntityType), leftOperandEntityName, false), joinType, (Project.DAL.EntityType)Enum.Parse(typeof(Project.DAL.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Project.DAL.EntityType)Enum.Parse(typeof(Project.DAL.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the Project.DAL.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((Project.DAL.EntityType)entityTypeValue);
		}
