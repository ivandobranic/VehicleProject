...
namespace Project.DAL.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		public EntityQuery<VehicleMakeEntity> VehicleMake
		{
			get { return Create<VehicleMakeEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the VehicleModel entity</summary>
		public EntityQuery<VehicleModelEntity> VehicleModel
		{
			get { return Create<VehicleModelEntity>(); }
		}
